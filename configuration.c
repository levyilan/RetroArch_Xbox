    ...
    settings_t* settings, int* size)
{
    ...
    SETTING_BOOL("ui_companion_start_on_boot", &settings->bools.ui_companion_start_on_boot, false, ui_companion_start_on_boot, false);
    SETTING_BOOL("ui_companion_enable", &settings->bools.ui_companion_enable, false, ui_companion_enable, false);
    ...
    SETTING_BOOL("quick_menu_show_recording", &settings->bools.quick_menu_show_recording, false, quick_menu_show_recording, false);
    SETTING_BOOL("quick_menu_show_streaming", &settings->bools.quick_menu_show_streaming, false, quick_menu_show_streaming, false);
    ...
    SETTING_BOOL("quick_menu_show_start_recording", &settings->bools.quick_menu_show_start_recording, false, quick_menu_show_start_recording, false);
    SETTING_BOOL("quick_menu_show_start_streaming", &settings->bools.quick_menu_show_start_streaming, false, quick_menu_show_start_streaming, false);
    ...
    SETTING_BOOL("content_show_explore", &settings->bools.menu_content_show_explore, false, DEFAULT_MENU_CONTENT_SHOW_EXPLORE, false); // Causes a crash on Xbox
#endif
...
#endif /* HAVE_LAKKA */
#endif
    SETTING_BOOL("menu_show_information", &settings->bools.menu_show_information, false, menu_show_information, false);
...
#endif
    SETTING_BOOL("menu_show_help", &settings->bools.menu_show_help, false, menu_show_help, false);
    SETTING_BOOL("menu_show_quit_retroarch", &settings->bools.menu_show_quit_retroarch, true, menu_show_quit_retroarch, false);
    SETTING_BOOL("menu_show_restart_retroarch", &settings->bools.menu_show_restart_retroarch, false, menu_show_restart_retroarch, false);
    SETTING_BOOL("menu_show_reboot", &settings->bools.menu_show_reboot, false, menu_show_reboot, false);
    SETTING_BOOL("menu_show_shutdown", &settings->bools.menu_show_shutdown, false, menu_show_shutdown, false);
...
#ifdef HAVE_MIST
    SETTING_BOOL("menu_show_core_manager_steam", &settings->bools.menu_show_core_manager_steam, false, menu_show_core_manager_steam, false);
#endif
    ...
    SETTING_BOOL("save_file_compression", &settings->bools.save_file_compression, true, DEFAULT_SAVE_FILE_COMPRESSION, true);
    SETTING_BOOL("savestate_file_compression", &settings->bools.savestate_file_compression, true, DEFAULT_SAVESTATE_FILE_COMPRESSION, true);
    ...
    SETTING_BOOL("sort_savefiles_enable", &settings->bools.sort_savefiles_enable, true, default_sort_savefiles_enable, true);
    SETTING_BOOL("sort_savestates_enable", &settings->bools.sort_savestates_enable, true, default_sort_savestates_enable, true);
    SETTING_BOOL("sort_savefiles_by_content_enable", &settings->bools.sort_savefiles_by_content_enable, false, default_sort_savefiles_by_content_enable, false);
    SETTING_BOOL("sort_savestates_by_content_enable", &settings->bools.sort_savestates_by_content_enable, false, default_sort_savestates_by_content_enable, false);
    ...
    SETTING_BOOL("playlist_use_old_format", &settings->bools.playlist_use_old_format, false, DEFAULT_PLAYLIST_USE_OLD_FORMAT, false);
...
#ifdef HAVE_OZONE
    SETTING_BOOL("ozone_collapse_sidebar", &settings->bools.ozone_collapse_sidebar, true, DEFAULT_OZONE_COLLAPSE_SIDEBAR, true);
    ...
    settings_t* settings, int* size)
{
    ...
    SETTING_UINT("input_max_users", &settings->uints.input_max_users, true, input_max_users, true);
    ...
    SETTING_UINT("input_menu_toggle_gamepad_combo", &settings->uints.input_menu_toggle_gamepad_combo, true, DEFAULT_MENU_TOGGLE_GAMEPAD_COMBO, true);
